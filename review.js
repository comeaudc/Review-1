...
//Unicode is a universal encoding standard that uses 32bits (or 4 bytes) to represent different characters, numbers, symbols, and letters. Which allows for 2 billion different character combinations
// let ted = 'Teddy'
// let x = ted.charCodeAt(2)
// console.log(x)
...
const lastName = 'Comeau'
const fullName = firstName.concat(lastName)
// console.log(fullName)

// Create a string and make it return true using startsWith()
// console.log(fullName.startsWith('Dyl'))

// Now use any variable with endsWith() and return false
// console.log(fullName.endsWith('eaux'))

// Finish the following sentence. Use includes() and return true.
const ozgur = 'Once upon a time Ozgur looked up at the Moon, and realized that his ancestors before were looking back'
// console.log(ozgur.includes(`ancestors`))
...
const idc = `I DON'T GIVE A HOOT. I DON'T KNOW HOW TO WHISPER!!!`
// console.log(idc.toLowerCase())
...
let trimmed = `       This needs to loose some size       `
...
// for(things in whateverQueenBeySaid){
//   console.log(things)
// }
...
// push() - adds one or more elements to the end of the array and returns array
// pop() - removes the last element from an array. Changes legnth of array. Returns popped element
// unshift() - adds one or more elements to the start of an array and returns new array
// shift() - removes first element in an array. Changes legnth of an array
// concat() - merges 2 or more array. does not change arrays but returns new array.
// splice() - changes contents of array by removing existing elements and/or putting a new element in its place
// slice() - returns a copy of a portion of an array as a new array object.  Seleted using start and end indces 
// sort() - sorts elements of an array alphabetically/by UTF-16 code unit values
// includes() - determines whether an array includes a certain value. Includes returns true or false
// indexOf() - returnsfirst index where specific element can be found in array. If not found returns -1
// length - is a propery of arrays that tells us the number of elements the array contains
...
const exoticFruits = ['dragonfruit', 'pomegranate', 'pineapple']
const totalArray = fruits.concat(exoticFruits)
// console.log(totalArray)

// Print the last two exotic fruits without altering the newly concatenated array.
// console.log(totalArray.slice(-2))
...
const monalissaIsNeat = monalissaIsMessy.sort()
// console.log(monalissaIsNeat)
...
// let goodWords = RafaelNoBadWords.split(' ')
// console.log(goodWords.filter(word => word != `badword`).join(' '))
...
const startValue = 0;
const total = numbersToAddUp.reduce((val1, val2) => val1 + val2, startValue)
// console.log(total)
...
// function strParam(string) {
//   console.log(`This is my ${string}`)
// }
// strParam('Dont play with me haha')
...
const dylan = function() {
  console.log(`Dylan Comeau`)
}
...
// Object.keys(bulbasaur).forEach(element => console.log(element))
